...
<template>
  <div
    v-if="showModalLogin"
    class="absolute flex justify-center items-center backdrop-blur-sm top-0 right-0 -left-0 -bottom-0"
  >
        ...
        <div class="flex flex-col gap-6">
          <div class="relative">
            <input
              type="text"
              id="email"
              class="block px-2 pb-2 pt-3 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
            />
            <label
              for="email"
